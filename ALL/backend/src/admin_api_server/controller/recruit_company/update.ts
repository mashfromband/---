...
type RequestType =
    paths["/recruit-company/{recruitCompanyId}"]["put"]["requestBody"]["content"]["application/json"];
type SuccessResponseType =
    paths["/recruit-company/{recruitCompanyId}"]["put"]["responses"]["200"]["content"]["application/json"];

export class UpdateRecruitCompanyAdminAPIController extends BaseAPIController {
    public async update() {
