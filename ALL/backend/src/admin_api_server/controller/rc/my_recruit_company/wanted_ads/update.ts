...
type RequestType =
    paths["/rc/my-recruit-company/wanted-ads/{wantedAdsId}"]["put"]["requestBody"]["content"]["application/json"];

export class PutUpdateMyRecruitCompanyWantedAdsAPIController extends BaseAPIController {
    public async update() {
        ...
        const result = await DBUtil.withTransaction(async (queryRunner: QueryRunner, manager: EntityManager) => {
            ...
            wantedAds.recruteCompany = recruitCompany;
