...
const authServerBaseUrl = "https://auth.realizelearning.net";

const contentsServerPort = 7100;
const contentsServerBaseUrl = "https://www.realizelearning.net";
const contentsServerOpenBaseUrl = "https://www.realizelearning.net";

const apiServerPort = 7001;
const apiServerBaseUrl = "http://api.realizelearning.net";

const adminApiServerPort = 7002;
const adminApiServerBaseUrl = "http://admin-api.realizelearning.net";
...
const config = {
    ...
    authServer: {
        ...
        cors: {
            config: {
                origin: [
                    "https://www.realizelearning.net",
                    "https://manage.realizelearning.net",
                ],
                methods: [
        ...
        userWithdrawal: {
            mailAddress: {
                secret: "QoNB0QspResNGSXmo3_X6hTjzjGX0St7HJ6bWNDp610nC1I86_mlgk7bzOledSxO",
            },
        },
    },
    ...
    digico: {
        ...
        api: {
            gift: {
                endPoint: "https://user.digi-co.net/api/v1/gift",
            },
            reference: {
                endPoint: "https://user.digi-co.net/api/v1/gift/reference",
            },
        },
    },
