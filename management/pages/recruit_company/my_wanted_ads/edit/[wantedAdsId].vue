...
const onSubmit = async (event: FormSubmitEvent<Schema>) => {
  ...
  type UpdateRecruitCompanyRequest = paths["/rc/my-recruit-company/wanted-ads/{wantedAdsId}"]["put"]["requestBody"]["content"]["application/json"];
  ...
  const { error } = await useCallApi(
    apiEndpoint.value.endpoint + `/v1/rc/my-recruit-company/wanted-ads/${getAdDetailResponse.value.id}`,
    {
      method: "put",
      body: requestBody,
    },
