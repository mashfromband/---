...
type RequestType =
    paths["/rc/my-recruit-company/wanted-ads"]["post"]["requestBody"]["content"]["application/json"];

export class PostCreateMyRecruitCompanyWantedAdsAPIController extends BaseAPIController {
    public async create() {
