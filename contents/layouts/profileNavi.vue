      ...
      <template #left>
        <UAside class="-mx-4 p-4 lg:mx-0 bg-el_yellow-400 dark:bg-gray-800/50" :ui="{wrapper:'lg:max-h-none min-w-[320px]'}">
          ...
          <template #bottom>
            ...
            <AdNinja sizeType="300x250" adScriptUrl="https://adm.shinobi.jp/s/cdb146d0ebce36d073e02335bfb0c676" />
            </div>
          </template>
        </UAside>
      </template>
...
const sublinks = [{
  ...
  {
    label: "称号",
    to: "/home/record/honor",
    icon: "i-ph-medal-military"
  },
  {
    label: "クエストクリア履歴",
    to: "/home/record/quest",
